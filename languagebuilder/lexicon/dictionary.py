...
# NOTE: exponents are being pulled out of Vocabulary (previously "Dictionary")
#   - vocabulary defines and gives sounds for headwords
#   - TODO: Summary displays visible grammatical info
#   - grammatical exponents are intended to be used alongside bases/headwords
...
class Vocabulary():
    ...
    # # heavily formatting pre,mid,post here
    # #   - also define when accessed instead of stored?
    # #   - go through exponent entries when using search

    def add(self, sound=None, spelling=None, change=None, exponent=None, definition=None, pos=None):
